...
-- Control for key press detection on the context menu. Set to -1 to disable the right mouse button behaviour.
Config.MenuControlKey = -1

-- Control used to interact/confirm an option (default INPUT_CONTEXT / E)
Config.InteractControl = 38

-- Text label displayed inside the interaction prompt
Config.InteractKeyLabel = 'E'

-- Time in milliseconds the interaction key needs to be held before triggering the action
Config.HoldDuration = 650

-- Scroll controls to cycle through available options (defaults: mouse wheel up/down)
Config.ScrollUpControl = 241
Config.ScrollDownControl = 242

-- Whether to disable ALL controls or only specificed ones
Config.DisableControls = true

-- Command that opens the personalization menu
Config.PersonalizeCommand = 'targetsettings'

-- Controls for opening the personalization menu while targeting (hold modifier + press open control)
Config.SettingsModifierControl = 19 -- INPUT_CHARACTER_WHEEL (Left Alt)
...
Config.InteractPromptDistance = 1.5
Config.InteractPromptScanRadius = 3.0
